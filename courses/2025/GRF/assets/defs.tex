...
% No chapter breaks (mimic chapters with \subsection*)
...
\noindent (i) We say that $uv$ joins $u$ and $v$, that $u$ and $v$ are adjacent, that $u$ is a neighbor of $v$ (and vice versa), and that $uv$ is incident to $u$ (and $v$). 
\noindent (ii) The neighbourhood of $u \in V$, denoted as $N(u)$, is the set of all vertices adjacent to $u$. The closed neighbourhood of $u$, denoted $N[u]$, is the neighbourhood of $u$ together with $u$ itself. That is,
...
\end{definition}
\subsection{Compliments and Combinations of Graphs}
\begin{definition}
...
\end{definition}
\subsection{Mappings between graphs}
\begin{definition}
...
\end{definition}
\subsection{$k$-connected graphs and $k$-edge-connected graphs}
\begin{definition}
...
\end{definition}
\subsection{Chvátal’s Art Gallery Theorem and Fáry’s Theorem}
\begin{definition}
...
\end{definition}
\subsection{Introduction to edge-colourings}
\begin{definition}
...
\end{definition}
\subsection{Group actions and the Orbit-Stabilizer Theorem}
\begin{definition}
