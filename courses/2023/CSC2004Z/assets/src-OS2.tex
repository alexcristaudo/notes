...
\begin{center}
\includegraphics[scale = 0.9]{OS2_assets/response.png}
\end{center}
\subsection{Average Waiting Time}
\begin{center}
\includegraphics[scale = 0.9]{OS2_assets/waiting.png}
\end{center}
...
\begin{center}
\includegraphics[]{OS2_assets/throughput.png}
\end{center}
\section{Discussion}
\subsection{Waiting time and Turnaround Time}
