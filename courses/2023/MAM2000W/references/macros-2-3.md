...
status: needs-review
source: latex
assets: [macros-2-3.tex]
---
> [!warning]
> Compiled from **macros-2-3.tex** by the built-in LaTeX renderer — No \begin{document} — rendering the file as a fragment. Unhandled commands left as-is: \newcommand, \id, \taking, \xrightarrow, \inv, \DeclareMathOperator, \diam, \ord…
